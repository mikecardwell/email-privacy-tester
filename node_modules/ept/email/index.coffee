  ...
  exports.sendEmail = ( data, cb ) ->
    ...
    getParts data, ( err, html, css, svg ) =>
      ...
      mailerOpt =
        ...
        attachments:  [
          { filename: "#{data.callback_code}.css", contents: css, cid: "#{data.callback_code}.css@#{data.base_domain}", contentDisposition: 'inline' }
          { filename: "#{data.callback_code}.svg", contents: svg, cid: "#{data.callback_code}.svg@#{data.base_domain}", contentDisposition: 'inline' }
        ]
