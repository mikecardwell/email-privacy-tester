...
## Module exports
  ...
  exports.sendEmail = ( data, cb ) ->
    ...
    getParts data, ( err, html, css, svg ) =>
      ...
      js1 = 'alert(/XSS(1) security vulnerability found! Please report this to xss@emailprivacytester.com/.source)';
      js2 = "<script>#{js1}</script>".replace '(1)', '(2)'
      ...
      mailerOpt =
        ...
        attachments:  [
          ...
          { filename: "#{js2}.#{data.callback_code}.js", contents: js1, cid: "#{data.callback_code}.js@#{data.base_domain}", contentDisposition: 'inline', contentType: 'application/javascript' }
        ]
