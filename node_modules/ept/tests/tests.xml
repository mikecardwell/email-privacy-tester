...
<audio src="http://TRACKING_URL/" preload="metadata" autoplay="autoplay"></audio>
	...
	<background>
		<name>Background attribute</name>
		<type>http</type>
		<desc><![CDATA[
...
<body background="http://TRACKING_URL/">
	...
	<background_image>
		<name>CSS background-image</name>
		<type>http</type>
		<desc><![CDATA[
In the <body> of the HTML part, place a tag as follows:
...
<style type="text/css">@import 'http://TRACKING_URL/';</style>
	...
	<disposition_notification>
		<name>Disposition Notification</name>
		<type>email</type>
		<desc><![CDATA[
...
This test wont leak your IP address, but it will leak the IP address of your DNS resolvers, which can provide information on which ISP you're using and potentially your general location.

Some mail servers do DNS lookups on these URLs as part of their spam filtering process, so you may see the IP address of the mail servers DNS resolvers here, as well as, or instead of, your own.
		]]></desc>
	</dns_link>
	<link_prefetch>
		<name>Link Prefetch</name>
		<type>http</type>
		<desc><![CDATA[
In the <body> of the HTML part, place a tag as follows:
...
<iframe src="data:text/html;charset=utf-8,&lt;html&gt;&lt;head&gt;&lt;/head&gt;&lt;body&gt;&lt;img src=&quot;http://TRACKING_URL/&quot;&gt;&lt;/body&gt;&lt;/html&gt;"></iframe>
		...
		<content><type>image/png</type><path>icon/exclamation.png</path></content>
	</iframe_img>
	<img>
		<name>Image tag</name>
		<type>http</type>
...
<input type="image" src="http://TRACKING_URL/">
	...
	<js>
		<name>Script tag (javascript)</name>
		<type>http</type>
		<desc><![CDATA[
In the <body> of the HTML part, place a tag as follows:
...
<script type="text/javascript" src="http://TRACKING_URL/"></script>
	...
	<script_in_script>
		<name>Script inside script</name>
		<type>http</type>
		<desc><![CDATA[
In the <body> of the HTML part, place a tag as follows:
...
Some webmail implementations might strip out the two "<script></script>" parts
	...
	<svg_background_img>
		<name>SVG attachment with CSS</name>
		<type>http</type>
		<desc><![CDATA[
In the <body> of the HTML part, place a tag as follows:
...
background-image:url('http://TRACKING_URL/');
	...
	<svg_inline_image>
		<name>SVG inline with remote image</name>
		<type>http</type>
		<desc><![CDATA[
In the <body> of the HTML part, place a tag as follows:
...
<link rel="alternate" type="application/rss+xml" href="http://TRACKING_URL/">
	...
	<video>
		...
		<type>http</type>
		<desc><![CDATA[
In the <body> of the HTML part, place tags as follows:

<video autoplay="true" src="http://TRACKING_URL/"></video>]]></desc>
	</video>
	<video_poster>
		<name>Video poster</name>
		<type>http</type>
		<desc><![CDATA[
In the <body> of the HTML part, place tags as follows:

<video poster="http://TRACKING_URL/" autoplay="true" src="http://ANY_OTHER_URL/"></video>]]></desc>
	</video_poster>
	<video_mp4>
		<name>Video MP4</name>
		<type>http</type>
